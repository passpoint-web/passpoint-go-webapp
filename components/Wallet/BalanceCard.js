...
const BalanceCard = ({ styles }) => {
  ...
  return (
    <>
      {searchParams.get("createPinModal") ? (
        <CreatePinModal
          handlePinCreation={() => handleModals("transferModal", "bank")}
        />
      ) : (
        <></>
      )}
      {searchParams.get("addMoneyModal") === "true" ? (
        <AddMoneyModal styles={styles} />
      ) : (
        <></>
      )}
      {searchParams.get("transferModal") ? (
      ...
      <div className={styles.balance_card}>
        ...
        <div className={styles.rhs}>
          <div className={styles.top}>
            <BorderIconBtn classProps="no-border i sd">
              <AlertIcon /> Set Alert
            </BorderIconBtn>
          </div>
