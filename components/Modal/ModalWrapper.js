...
const ModalWrapper = ({
  ...
  return (
    <div ref={modalCtnRef} className={`${styles.modal_container} reveals`}>
      <div
        ref={modalBgRef}
      ...
      >
        {topClose ? (
          <button className={`${styles.close_btn} button`} onClick={onClose}>
            <CancelIcon />
          </button>
        ) : (
          <></>
        )}
        <div className={styles.child} style={{ ...contentStyle }}>
          ...
          {hasBottomActions ? (
            <div
              className={`${styles.bottom} ${
                bottomCancelNeeded ? styles.end : ""
              }`}
            >
              {bottomCancelNeeded ? (
                <Button
                  className={`secondary ${ctaBtnType} ${
                    secNegative ? "negative" : ""
                  }`}
