			...
			<div className={styles.profile_card}>
				...
				<div className={styles.content}>
					<div className={styles.info}>
						...
						<div className={styles.value}>{savedCredentials.firstName || '-'}</div>
					</div>
					<div className={styles.info}>
						<div className={styles.heading}>Last Name</div>
						<div className={styles.value}>{savedCredentials.lastName || '-'}</div>
					</div>
					<div className={styles.info}>
						<div className={styles.heading}>Phone Number</div>
						<div className={styles.value}>{savedCredentials.phoneNumber || '-'}</div>
					</div>
				</div>
			</div></>
	)
				...
				<div className={styles.inner}>
					...
					<div className={styles.content}>
						<div className={styles.info}>
							...
							<div className={styles.value}>{savedCredentials.businessName || '-'}</div>
						</div>
						<div className={styles.info}>
							<div className={styles.heading}>Business Type</div>
							<div className={styles.value}>{savedCredentials.businessType || '-'}</div>
						</div>
						<div className={styles.info}>
							<div className={styles.heading}>Business Identification Number</div>
							<div className={styles.value}>{savedCredentials.rcNumber || '-'}</div>
						</div>
						<div className={styles.info}>
							<div className={styles.heading}>Email Address</div>
							<div className={styles.value}>{savedCredentials.email || '-'}</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div className={styles.profile_card}>
				...
				<div className={styles.content}>
					<div className={styles.info}>
						...
						<div className={styles.value}>{savedCredentials.address || '-'}</div>
					</div>
				</div>
			</div></>
	)
