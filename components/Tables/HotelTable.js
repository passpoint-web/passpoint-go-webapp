...
import Pagination from "./Pagination/WalletPagination"
// import Loader from "../Btn/Loader"
import { getCredentials } from "@/services/localService"
import FWLoader from "../FWLoader"
import Input from "../Dashboard/Input"
// import HotelDetailsModal from "../Travel/HotelDetailsModal"
import Button from "../Btn/Button"
import { payment } from "@/services/restService/payment"
// eslint-disable-next-line no-unused-vars
import { duration } from "moment"

const HotelTable = ({ title, modalStyles }) => {
  ...
  const [hotelDetailVisible, setHotelDetailVisible] = useState(null)
  // eslint-disable-next-line no-unused-vars
  ...
  const handleHotelDetails = (f) => {
    setHotelDetails(f)
    setHotelDetailVisible(true)
  }
  ...
  return (
    <>
      {hotelDetailVisible ? (
        ...
        // <HotelDetailsModal
        //   closeModal={() => setHotelDetailVisible(false)}
        //   styles={modalStyles}
