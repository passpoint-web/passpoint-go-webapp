...
const IdentityPage = ({ styles }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      const response = await publicProfile.uploadBusinessLogo({
        logo: businessLogo,
        submitType,
      });
      ...
      savePublicProfile({
        ...savedPublicProfile,
        profileStage:
          savedPublicProfile.profileStage > 1
            ? savedPublicProfile.profileStage
            : 1,
      });
    ...
    <>
      ...
      <div className={styles.inner}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          />
          <Input label="Business Name" disabled defaultValue={businessName} />
