							...
							<div className={styles.inner}>
								<div className={styles.form_row}>
									...
									<div className={styles.form_group}>
										...
										<input placeholder="Jon" id="first-name" value={firstName} onChange={(e)=>setFirstName(e.target.value)} />
									</div>
								</div>
								...
								<div className={styles.terms}>
									...
									<p>By clicking, you indicate your role as the owner or manager of the business</p>
								</div>
								<div className={styles.terms}>
									<CheckBox value={checked}  onChange={toggleChecked} />
