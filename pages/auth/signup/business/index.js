              ...
              <div className={styles.inner}>
                <div
                  className={`${styles.form_group} ${
                    ctaClicked && !businessName ? styles.error : ""
                  }`}
                >
                ...
                <div
                  className={`${styles.form_group} ${
                    ctaClicked && !validEmail(email) ? styles.error : ""
                  }`}
                >
                  ...
                  />
                  {ctaClicked && !validEmail(email) ? (
                    <FeedbackInfo message="Business email needed" />
                  ) : (
                    <></>
                  )}
                </div>
                <div className={`${styles.form_group}`}>
                  ...
                  />
                  {ctaClicked && !businessType ? (
                    <FeedbackInfo message="Business type needed" />
                  ) : (
                    <></>
                  )}
                </div>
                ...
                <div
                  className={`${styles.form_group} ${
                    ctaClicked && !businessId ? styles.error : ""
                  }`}
                >
                  ...
                  />
                  {ctaClicked && !businessId ? (
                    <FeedbackInfo message="Business ID No. needed" />
                  ) : (
                    <></>
                  )}
                </div>
